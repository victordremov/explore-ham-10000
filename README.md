...
--- | --- | --- | ---
Treatment cost is high | Build a model that detects a specific malignant lesion type with same sensitivity as human experts but higher specificity | Use model as a "second opinion" tool for dermatoscopists | Less benigh lesions are to be biopsyed or excited leading to less treatment and after-treatment costs. Also, less impact on health of patients with benigh lesions
